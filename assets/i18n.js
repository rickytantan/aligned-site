...
(function () {
  ...
  var TEXT = [
    ...
    /* ================= INDEX ================= */
    ["We treat the root cause of your pain, not just the symptom. Precise, evidence-based spinal care built around long-term recovery.", "我们治疗疼痛的根源，而不只是症状。精准、以实证为本的脊椎护理，专为长期康复而设。"],
    ["Years of practice", "年临床经验"],
    ["Patients realigned", "位患者重获平衡"],
    ["Average patient rating", "平均患者评分"],
    ["Aligned exists to provide the best pain management solution by improving your spinal health through the Gonstead Chiropractic system.", "Aligned 致力于通过冈斯特脊椎矫正系统改善你的脊椎健康，提供最佳的疼痛管理方案。"],
    ["Our doctors are committed to the highest quality of care, delivered with the compassion, excellence and professionalism you deserve. We start with why, then we get to work.", "我们的医生坚持最高质量的护理，以你应得的关怀、卓越与专业态度对待每位患者。我们先厘清「为什么」，再着手治疗。"],
    ["Relief should not be temporary.", "缓解不该只是暂时的。"],
    ["Learn more", "了解更多"],
    ["The gold standard for chiropractic systems", "脊椎矫正系统的黄金标准"],
    ["Gonstead — precise, full-spine, trusted worldwide", "冈斯特——精准、全脊椎、全球信赖"],
    ...
    ["Gentle, safe care for back and pelvic comfort through every trimester.", "温和、安全的护理，呵护整个孕期的腰背与骨盆舒适。"],
    ["Gentle assessments and care tailored to growing spines and developing posture.", "为成长中的脊椎与发育中的体态量身定制的温和评估与护理。"],

    /* services */
    ["Evidence-based care tailored to your body. From precise spinal adjustments to active rehab — and gentle care for the companions who move beside you.", "以实证为本、为你的身体量身定制的护理。从精准的脊椎矫正到主动康复——以及为陪伴你的毛孩提供的温和护理。"],
    ["Chiro Adjustment", "脊椎矫正"],
    ["Specific, full-spine Gonstead adjustments that restore alignment and take pressure off the nerve — treating the root cause, not just the symptom.", "精准的全脊椎冈斯特矫正，恢复力线、减轻神经压力——从根源治疗，而不只是症状。"],
    ["See the method", "了解方法"],
    ["Rehab", "康复训练"],
    ...
    ["A dual-probe Nervoscope detects localised skin-temperature differences caused by nerve inflammation.", "双探头神经温度仪检测神经发炎引起的局部皮温差异。"],
    ...
    ["Daniel believes recovery is a partnership. His consultations are famously unhurried — because a patient who understands their spine makes better decisions for it, long after they leave the clinic.", "Daniel 相信康复是一场合作。他的问诊以从容闻名——因为了解自己脊椎的患者，即使离开诊所很久，也能为它做出更好的决定。"],
    ...
    ["Sarah has a reputation for finding what others miss. Patients with long, complicated histories tend to end up in her room — and leave with a shorter, clearer story about what is actually going on.", "Sarah 以发现别人遗漏之处著称。病史冗长复杂的患者往往会来到她的诊室——离开时，对自己的状况有了更简短、更清晰的答案。"],
    ...
    /* ================= CHIROPRACTIC ================= */
    ["Dr. Clarence S. Gonstead was a mechanical engineer before he was a chiropractor. He brought one principle to the spine —", "Dr. Clarence S. Gonstead 在成为脊椎矫正师之前，是一名机械工程师。他为脊椎带来了一个原则——"],
    ["a structure is only as sound as its foundation", "结构的稳固程度取决于它的地基"],
    ["— and turned it into the most precise system of spinal analysis in chiropractic. His small-town Wisconsin clinic grew into the largest in the world, with its own airstrip and hotel for the patients who flew in from every continent.", "——并将其发展成脊椎矫正领域最精准的脊椎分析系统。他在威斯康星小镇的诊所成长为全球最大的脊椎矫正诊所，甚至设有自己的飞机跑道与酒店，接待从各大洲飞来的患者。"],
    ["See the Method", "观看方法"],
    ["“Find the subluxation, accept it where you find it, correct it, and leave it alone.”", "「找到半脱位，在它所在之处接受它，矫正它，然后放手。」"],
    ...
    ["When one segment misaligns and stops moving, it presses on the nerve and the body compensates around it. That is the restriction you feel as pain and stiffness.", "当某一节段错位并停止活动，它会压迫神经，身体则围绕它代偿。那种受限，就是你感觉到的疼痛与僵硬。"],
    ...
    ["With the pressure off the nerve, the body does what it was built to do — heal. Movement returns, and this time it holds.", "神经压力解除后，身体便会做它天生该做的事——自我修复。活动恢复，而这一次，效果得以保持。"],
    ...
    ["A dual-probe Nervoscope detects skin-temperature differences caused by nerve inflammation.", "双探头神经温度仪检测神经发炎引起的皮温差异。"],
    ["Moving the spine through its ranges to find joints that are locked or not travelling freely.", "让脊椎活动至各个范围，找出卡住或无法自由活动的关节。"],
    ["Symptoms caused by misalignment.", "由脊椎错位引起的症状。"],
    ...
    ["Gentle, safe care for back and pelvic comfort.", "温和、安全地呵护腰背与骨盆舒适。"],
    ...
    ["Yes — techniques are adapted to each body. We use gentler, more specific setups for children, older spines and pregnancy. The five-point examination first tells us exactly what is (and is not) safe to adjust.", "安全——手法会因人而异地调整。对儿童、年长的脊椎与孕期，我们采用更温和、更精准的方式。五项检查会先告诉我们，什么可以矫正、什么不可以。"],
    ...
    ["1 in 4", "四分之一"],
    ["dogs develops arthritis in its lifetime — and the signs show up in movement long before they show up on a scan.", "的狗一生中会患上关节炎——而征兆在扫描显示之前，早已出现在动作上。"],
    ['Not "just age"', "不只是「老了」"],
    ...
    ["Gentle, animal-specific techniques — most pets relax into it", "温和、专为动物设计的手法——多数宠物会放松下来"],
    ...
    ["Many pets show visible change within one to three visits. Chronic or age-related cases may benefit from ongoing maintenance every few weeks. We will tell you honestly what we see after the first assessment.", "许多宠物在一到三次到访内就有明显变化。慢性或与年龄相关的情况，或许可受益于每隔数周的持续保养。首次评估后，我们会如实告诉你我们的观察。"],
    ...
    ["Most disc cases respond to precise, conservative care. What the research says — and when surgery is the answer.", "大多数椎间盘问题对精准的保守治疗有反应。研究怎么说——以及何时手术才是答案。"],
    ["May 2026", "2026年5月"],
  ...
  var HEAD = [
    ...
    ["Our services.", "我们的服务。"],
    ["Five-point diagnostics, down to the millimetre.", "五项精准诊断，细致入微。"],
    ...
    /* chiropractic */
    ['Built by an engineer. <span class="alt">Trusted for a century.</span>', '由工程师创立，<span class="alt">历经百年信赖。</span>'],
    ...
    /* pet-chiro */
    ["Your dog is not getting lazy or old, <span class=\"alt\">he's actually stuck.</span>", '你的狗狗不是变懒或变老，<span class="alt">而是身体「卡住」了。</span>'],
    ["Dogs are built to hide it.", "狗狗天生懂得隐藏疼痛。"],
    ["His spine works exactly like yours.", "它的脊椎和你的一模一样。"],
